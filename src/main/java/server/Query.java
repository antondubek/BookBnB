...
public class Query {
    ...
    public final static String FOLLOW_PEOPLE = "INSERT INTO Users_followers (Users_id, friend) VALUES ((SELECT id FROM Users WHERE email = ?),(SELECT id FROM Users WHERE email = ?));";
}
