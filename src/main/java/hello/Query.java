...
public class Query {
    ...
    public static String insertNewUser = "INSERT INTO Users (name, email, city) VALUES (?, ?, ?);";
    public static String insertNewUserPassword = "INSERT INTO Users_password VALUES ((SELECT id FROM Users WHERE email = ?), ?);";
