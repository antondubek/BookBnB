...
public class Query {
    ...
    public static String fetchUserBooks = "SELECT ISBN, title, author, book_version, available FROM Book " +
                                          ...
                                          "WHERE EMAIL = '%s';";
    public static String checkIfBookInDB = "SELECT ISBN FROM Book WHERE ISBN = '%s';";
    public static String insertNewBook = "INSERT INTO Book VALUES ('%s', '%s', '%s', '%s');";
    public static String addUserToBook = "INSERT INTO Users_book (Users_id, Book_ISBN, available) VALUES ((SELECT id FROM Users WHERE email = '%s'), '%s', false);";
